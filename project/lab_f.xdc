...
## buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { right_btn }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { left_btn }]; #IO_L19P_T3_16 Sch=btn[1]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { place_btn }]; #IO_L19P_T3_16 Sch=btn[1]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { pwr }]; #IO_L19P_T3_16 Sch=btn[1]

set_property BITSTREAM.GENERAL.COMPRESS TRUE [current_design]
set_property BITSTREAM.CONFIG.CONFIGRATE 33 [current_design]
set_property CONFIG_MODE SPIx4 [current_design]

# https://www.circuitspecialists.com/content/1103023/01DIG41032835.pdf -> PIO03 -> A16 (pwr), PIO5 (place)-> C15 (pins 3 and 5 respectively)